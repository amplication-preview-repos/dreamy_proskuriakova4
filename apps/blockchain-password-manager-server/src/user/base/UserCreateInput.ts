...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => MasterKeyCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => MasterKeyCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => MasterKeyCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => VaultCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => VaultCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => VaultCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
